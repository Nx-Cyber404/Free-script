...
"""
logo2 = """
\x1b[1;92m➣ NAME :           💗 OMAR FARUK💗
\x1b[1;91m➣ PGE NAME :  💣TERMUX TEACHER OMAR💣
\x1b[1;93m➣ WHATSAPP NO :   👬 +8801725897896 👬
...
def menu():
	os.system('clear')
	print logo
	print "\033[1;96m💖━━━━━━━━━💘💘💘(MAFIA-KILLER-OMAR)💘💘💘━━━━━━━━💖\n" 
...
def action():
	...
	if ahmad =='':
		...
		os.system('xdg-open https://youtube.com/channel/UCdEcWYqWwF-Yc8OsmhEaSxg')
		login()
	elif ahmad =='0':
		exb()
	else:
